...
public class Place {
    ...
    public Place(String placeName, String placeDesciption, List<String> placeImages, String placeRating, String placeAddress, String placeOpenTime, String placeType, String placePrice, String linkText, List<Comment> listComment) {
